...
本目录保留为查全型附录，适合系统补学术搜索、开放图谱、PDF 解析、引文导航、知识库与引用管理。
...
| 当前任务 | 更适合先看 |
| --- | --- |
| 建立论文池、找综述入口 | [文献检索与阅读](./文献检索与阅读.md)、[学术搜索与开放图谱](./学术搜索与开放图谱.md) |
| 追引文、看研究地图、找相邻工作 | [引文导航与研究地图](./引文导航与研究地图.md) |
| 处理 PDF、图表、附录和正文抽取 | [PDF解析与阅读加工](./PDF解析与阅读加工.md) |
| 沉淀 Zotero、BibTeX、笔记和长期知识资产 | [知识管理与引用](./知识管理与引用.md) |
