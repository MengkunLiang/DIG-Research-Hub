...
本目录保留为查全型附录，适合系统补 `Skills` 生态、跨宿主技能库、科研专题 skill bundles，以及不同研究阶段的高频技能组合。

## 这一层适合什么时候进入

1. 需要系统扫公开 skills 生态，而不是只看单个任务页里的少量条目。
2. 需要补 `Claude Code / Codex / Copilot / OpenHands / Hugging Face` 等不同宿主的技能实现。
3. 需要把“选题、精读、实验、写作”阶段中的短条目扩成更完整的技能参考页。

## 推荐先看

- [Skills标准与生态](./Skills标准与生态.md)
- [Skill发现平台与精品合集](./Skill发现平台与精品合集.md)
- [科研向Skills合集](./科研向Skills合集.md)
...
| 当前任务 | 更适合先看 |
| --- | --- |
| 选题、方向扫描、情报搜集 | [科研向Skills合集](./科研向Skills合集.md)、[科研写作与文献Skills](./科研写作与文献Skills.md) |
| 文献检索、精读、知识沉淀 | [科研写作与文献Skills](./科研写作与文献Skills.md) |
| 实验执行、代码开发、benchmark | [科研工程与实验Skills](./科研工程与实验Skills.md) |
| 综述、novelty、审稿、写作 | [科研写作与文献Skills](./科研写作与文献Skills.md) |
| 科学计算、生物医药、材料等方向 | [科学计算与领域Skills](./科学计算与领域Skills.md) |
