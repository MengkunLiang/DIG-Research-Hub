...
| Skill发现平台与精品合集 | 仓库内附录 | 适合继续扩充 AI/ML、评测、数据与工程类 skills。 | [91-Skills/Skill发现平台与精品合集](../91-Skills/Skill发现平台与精品合集.md) |
...
| MCP标准与发现平台 | 仓库内附录 | 适合继续找平台类、聚合类和通用工具类 MCP。 | [92-MCP/MCP标准与发现平台](../92-MCP/MCP标准与发现平台.md) |
...
| HPOBench | HPO benchmark | 适合比较多保真 HPO、预算敏感优化和可复现实验设置。 | [automl/HPOBench](https://github.com/automl/HPOBench) |
...
| Tevatron / ranx | retrieval toolkit / evaluation library | 适合 dense retrieval 原型、排序评测、统计检验与结果表导出。 | [texttron/tevatron](https://github.com/texttron/tevatron)、[AmenRa/ranx](https://github.com/AmenRa/ranx) |
...
| cleanlab | data-centric AI | 适合数据质量诊断、标签问题发现和数据中心实验迭代。 | [cleanlab/cleanlab](https://github.com/cleanlab/cleanlab) |
...
- Skills：优先回看 [91-Skills/科研工程与实验Skills](../91-Skills/科研工程与实验Skills.md)、[91-Skills/科学计算与领域Skills](../91-Skills/科学计算与领域Skills.md)、[91-Skills/Skill发现平台与精品合集](../91-Skills/Skill发现平台与精品合集.md)。
