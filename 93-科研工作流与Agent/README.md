...
本目录保留为查全型附录，适合系统补科研 agent、deep research、自动科研闭环、多代理协作和研究工作流框架。本目录优先放 `已开源` 项目；如果某系统目前只公开论文、未见官方仓库，会单独标注。
...
| Virtual Scientists (VirSci) | ACL 2025 Long | 多代理 scientific idea generation、science-of-science 风格协作模拟 | [ACL Anthology](https://aclanthology.org/2025.acl-long.1368/) / [open-sciencelab/Virtual-Scientists](https://github.com/open-sciencelab/Virtual-Scientists) |
...
| 系统 | 公开信息 | 说明 |
| --- | --- | --- |
| ResearchAgent | NAACL 2025 Long | 截止 `2026-04-16`，已核到 [ACL Anthology 论文页](https://aclanthology.org/2025.naacl-long.342/)，但暂未检到官方 GitHub 仓库。 |
...
| Virtual Scientists (VirSci) | 多代理 idea generation | 适合查看多科学家协作式 ideation 与新颖性提升机制。 | [open-sciencelab/Virtual-Scientists](https://github.com/open-sciencelab/Virtual-Scientists) |
