...
| Hugging Face MCP Server | 官方生态实现 | 官方开源实现，直接把 Hugging Face Hub、论文、数据集、Spaces 与 Gradio 工具接到 MCP 客户端。 | [huggingface/hf-mcp-server](https://github.com/huggingface/hf-mcp-server) |
...
| Hugging Face MCP Course | 开源课程 | 从入门到实战系统介绍 MCP，适合实验室培训和团队统一理解。 | [huggingface/mcp-course](https://github.com/huggingface/mcp-course) |
...
| MCPAdapt | 框架桥接层 | 适合把同一批 MCP servers 接到 `smolagents / LangChain / CrewAI / google-genai` 等 agent 框架。 | [grll/mcpadapt](https://github.com/grll/mcpadapt) |
